...
spark_df.write.format("delta").saveAsTable(delta_table_name)
...
measure_df.write.format("delta").saveAsTable(delta_table_name)
...
product_df.write.format("delta").saveAsTable(delta_table_name)
...
geo_df.write.format("delta").saveAsTable(delta_table_name)
